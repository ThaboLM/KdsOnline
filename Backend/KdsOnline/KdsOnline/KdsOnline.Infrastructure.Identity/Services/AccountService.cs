using KdsOnline.Application.DTOs.Account;
using KdsOnline.Application.DTOs.Email;
using KdsOnline.Application.Enums;
using KdsOnline.Application.Exceptions;
using KdsOnline.Application.Interfaces;
using KdsOnline.Application.Wrappers;
using KdsOnline.Domain.Settings;
using KdsOnline.Infrastructure.Identity.Helpers;
using KdsOnline.Infrastructure.Identity.Models;
...
namespace KdsOnline.Infrastructure.Identity.Services
{
