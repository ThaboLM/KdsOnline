using KdsOnline.Application.Features.Products.Commands;
using KdsOnline.Application.Features.Products.Commands.CreateProduct;
using KdsOnline.Application.Features.Products.Commands.DeleteProductById;
using KdsOnline.Application.Features.Products.Commands.UpdateProduct;
using KdsOnline.Application.Features.Products.Queries.GetAllProducts;
using KdsOnline.Application.Features.Products.Queries.GetProductById;
